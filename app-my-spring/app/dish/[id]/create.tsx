...
import {useCreateDishMutation} from "@/services/dishesService";
...
export default function CreateDishScreen() {
    ...
    const handleSubmit = async () => {
        console.log("Створення страви:", form);
        try {
            ...
            console.log("Dish creation is problem:", err);
        }
    };
                            ...
                            <View className={"space-y-2 w-full"}>
                                <TouchableOpacity onPress={pickImage} className={"mt-4 p-4 bg-blue-400 rounded-xl"}>
                                    <View className="flex flex-row items-center justify-center gap-2">
                                        <Text className="text-center text-white font-psemibold">Pick Images</Text>
